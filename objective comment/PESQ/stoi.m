function d = stoi(ref_wav, deg_wav)
...
[x,fs_signal1] = audioread(ref_wav);
[y,fs_signal2] = audioread(deg_wav);
if fs_signal1~=fs_signal2
    error('ref_wav and deg_wav should have the same sample rate');
else
    fs_signal = fs_signal1;
end
